...
\033[1;32m ███████ ███████ ███████ ██   ██ ██    ██ ██  █  ██ 
\033[1;32m      ██ ██   ██ ██   ██ ██   ██ ██    ██ ██ ███ ██ 
\033[1;32m ███████ ██   ██ ██   ██ ██████   ██████   ███ ███ \x1b[38;5;198m➤6.0
\x1b[38;5;46m───\x1b[38;5;198m──────────────────────────────────────────────\x1b[38;5;46m───
\x1b[38;5;198m[\033[1;32m+\x1b[38;5;198m] \033[1;32mDEVLOPER    	\033[1;32m➤  \033[1;32mARAFAT-XD
...
\x1b[38;5;198m[\033[1;32m+\x1b[38;5;198m] \033[1;32mTOOLS       	\033[1;32m➤  \033[1;32mBD × INDIA  FILE CLONE 
...
def method():
    ...
    def start(user):
     try:
        ...
        sys.stdout.write(f'\r {R}[{W}ARAFAT-XD{R}] {P}({Y}{loop}{W} / {W}{len(idx)}{P}) {W}• {G}{len(oku)}\r')
        sys.stdout.flush()
        loop+=1
        for pswd in pp:
              heads=None
              ...
              if 6==random.randint(1,300):
                 oku.append(acc)
                 print('\x1b[38;5;198m[\033[1;32mARAFAT-💚-OK\x1b[38;5;198m]\033[1;32m\033[1;32m'+acc+' \033[1;32m|\033[1;32m '+pswd)
                 open('/sdcard/ARAFAT-XD-🔥-DF-Ok.txt','a').write(f'{acc}|{pswd}\n')
                 break
              else:
                   continue   
